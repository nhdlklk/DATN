    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-12 text-center nopadding-right">
                <div class="top-logo">
                    <a href="{{route('home')}}"><img src="{{asset('img/icon.png')}}" style="margin-bottom: -25px;margin-top: -30px;margin-right: 87px;width: 218px;height: 80px;" alt="" /></a>
                </div>
            </div>
            <!-- logo end -->
            <!-- mainmenu area start -->
                ...
                <div class="mainmenu">
                    <nav>
                        <ul>
                            ...
                            <li class="expand">
                                <a href="{{route('get.all.product')}}">Sản phẩm</a>
                    ...
                    <div class="disflow">
                        <div class="expand dropps-menu">
                            ...
                            <ul class="restrain language" style="width: 200px">
                                @if(Auth::check())
                                <li><a href="{{route('user.dashboard')}}" title="Quản lý user">Quản lý</a></li>
