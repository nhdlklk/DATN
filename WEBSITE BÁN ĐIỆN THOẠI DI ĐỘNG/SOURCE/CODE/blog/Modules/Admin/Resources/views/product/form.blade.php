<form action="" method="POST" enctype="multipart/form-data">
   ...
   <div class="row">
    <div class="col-sm-8">
        ...
        <div class="form-group">
            <label for="name">Meta Descrption </label>
    ...
    <div class="col-sm-4">
        ...
        <div class="form-group">
            ...
            <input type="number" placeholder="1" class="form-control" name="pro_number" value="{{old('pro_number',isset($product->pro_number)? $product->pro_number : '')}}">

        </div>
        <div class="form-group">
            <img id ="out" src="{{asset('img/no-img.jpg')}}" alt="" style="width: 100%">
        </div>
        <div class="form-group">
            <label for="name">Avatar </label>
            <input type="file" id ="in" name="avatar" class="form-control">
    ...
    <button type="submit" class="btn btn-success">Luu Thong Tin</button>
</form>
@section('script')
